...
def prim(graph):
    ...
    # A heap to store the arcs and their respective weights
    ...
    while edges:
        ...
        if Vertex_v not in visited:
            ...
            # Including the adjacent arcs of Vertex_v to the heap
...
priority_queue.put((5, "K"))
priority_queue.put((2, "L"))
priority_queue.put((8, "M"))
priority_queue.put((6, "N"))
priority_queue.put((7, "O"))
priority_queue.put((4, "P"))
priority_queue.put((1, "Q"))
priority_queue.put((3, "R"))
priority_queue.put((10, "S"))
